...
const fr = {
  ...
  voiceDone: "Terminer",
  voicePreview: "Écoute ton message",
  voiceMicDenied: "Micro indisponible — tu peux quand même prévisualiser et envoyer.",
  send: "Envoyer",
  ...
  surpriseHeroTitle: "Des messages qui font plaisir…",
  surpriseHeroSub: "Ajoute une touche magique à tes conversations.",
  scratchCreateCta: "Créer un message à gratter",
  surpriseCategories: "Catégories",
  surpriseSeeAll: "Tout voir",
  catAmourSub: "Fais battre les cœurs",
  catAnnivSub: "Célèbre en grand",
  catNightSub: "Des rêves tout doux",
  catDaySub: "De la bonne énergie",
  catFetes: "Fêtes",
  catFetesSub: "Pour toutes les occasions",
  catGifts: "Cadeaux",
  catGiftsSub: "Surprends tes proches",
  catGiftShort: "Cadeau",
  catConfetti: "Confettis",
  catConfettiSub: "Mets de la couleur dans tes messages",
  catTimer: "Compte à rebours",
  catTimerSub: "Crée l’impatience",
  scratchCardTitle: "Carte à gratter",
  surpriseCreateTitle: "Créer une surprise",
  surpriseCreateSub: "Écris ton message et personnalise ta carte.",
  surpriseYourMessage: "Ton message",
  surpriseMessagePh: "Écris quelque chose de spécial…",
  surpriseChooseCard: "Choisir la carte",
  surpriseChooseCardTitle: "Choisir la carte ✨",
  surpriseChooseCardHint: "Sélectionne le design de ta surprise.",
  surpriseSearchCard: "Rechercher une carte…",
  chosen: "Choisie",
  surpriseCardPreview: "Aperçu de ta carte",
  surpriseLivePreview: "Aperçu en direct",
  scratchHere: "Gratte ici…",
  ...
  fxAddTitle: "Ajouter une animation ✨",
  fxAddHint: "Choisis un effet pour accompagner ton message.",
  fxSearch: "Rechercher une animation…",
  fxNoResults: "Aucune animation trouvée.",
  fxOthers: "Autres",
  fxOthersSub: "Plus d’effets bientôt.",
  fxAmour: "Amour",
  ...
  surpriseRecapMessage: "Message",
  surpriseRecapCard: "Carte",
  surpriseRecapAnim: "Animation",
  surpriseRecapNone: "Aucune",
  surpriseSelectedCard: "Carte choisie",
...
const en: Record<keyof typeof fr, string> = {
  ...
  voiceResume: "Resume",
  voiceDone: "Done",
  voicePreview: "Preview your note",
  voiceMicDenied: "Mic unavailable — you can still preview and send.",
  send: "Send",
  ...
  surpriseHeroTitle: "Messages that feel good…",
  surpriseHeroSub: "Add a little magic to your conversations.",
  scratchCreateCta: "Create a scratch message",
  surpriseCategories: "Categories",
  surpriseSeeAll: "See all",
  catAmourSub: "Make hearts race",
  catAnnivSub: "Celebrate big",
  catNightSub: "Sweet dreams",
  catDaySub: "Good energy",
  catFetes: "Holidays",
  catFetesSub: "For every occasion",
  catGifts: "Gifts",
  catGiftsSub: "Surprise your people",
  catGiftShort: "Gift",
  catConfetti: "Confetti",
  catConfettiSub: "Add color to your messages",
  catTimer: "Countdown",
  catTimerSub: "Build the anticipation",
  scratchCardTitle: "Scratch card",
  surpriseCreateTitle: "Create a surprise",
  surpriseCreateSub: "Write your message and personalize your card.",
  surpriseYourMessage: "Your message",
  surpriseMessagePh: "Write something special…",
  surpriseChooseCard: "Choose the card",
  surpriseChooseCardTitle: "Choose the card ✨",
  surpriseChooseCardHint: "Pick the design for your surprise.",
  surpriseSearchCard: "Search a card…",
  chosen: "Selected",
  surpriseCardPreview: "Card preview",
  surpriseLivePreview: "Live preview",
  ...
  fxAddTitle: "Add an animation ✨",
  fxAddHint: "Pick an effect to go with your message.",
  fxSearch: "Search an animation…",
  fxNoResults: "No animations found.",
  fxOthers: "Others",
  fxOthersSub: "More effects coming soon.",
  fxAmour: "Love",
  ...
  surpriseRecapMessage: "Message",
  surpriseRecapCard: "Card",
  surpriseRecapAnim: "Animation",
  surpriseRecapNone: "None",
  surpriseSelectedCard: "Selected card",
