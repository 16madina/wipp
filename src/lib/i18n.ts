...
const fr = {
  ...
  e2eBanner:
    "Les messages et les appels sont chiffrés de bout en bout. Touchez pour en savoir plus.",
  e2eInfoTitle: "Chiffrement",
  e2eInfoBody:
    "Seul toi et cette conversation avez les clés. Wipp ne peut pas ouvrir le contenu. Chaque message est scellé avec AES-256-GCM.",
...
const en: Record<keyof typeof fr, string> = {
  ...
  e2eInfoBody:
    "Only you and this conversation have the keys. Wipp cannot open the content. Each message is sealed with AES-256-GCM.",
